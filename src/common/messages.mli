...
module Factory : sig
  type t
  val create: DSA.key * DSA.key -> Derivations.UnassistedKeys.t -> t

  val make_auth_request: t -> authenticate_request
  ...
  val decode_revision_value: t -> revision_value -> revision_value


  val make_get_request: t -> string -> ?revision:string option -> unit -> get_request
  ...
  val decode_get_response: t -> get_response -> get_response


  val make_get_indices_request: t -> get_indices_request
  ...
  val decode_get_indices_response: t -> get_indices_response -> get_indices_response


  val make_get_revisions_request: t -> string -> get_revisions_request
  ...
  val decode_get_revisions_response: t -> get_revisions_response -> get_revisions_response


  val make_put_request: t -> string -> string -> string -> put_request
  ...
  val make_delete_request: t -> string -> ?revision:string option -> unit -> delete_request
  ...
  val make_register_request: t -> ?token:string -> unit -> register_request
  ...
  val make_unregister_request: t -> unregister_request
