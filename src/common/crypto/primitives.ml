...
module DSA = struct
  ...
  let rec dsa_primes rng bits =
    if bits < 512 || bits > 4096 || (bits mod 64) <> 0 then
  ...
  let sign ?rng msg key =
    ...
    in
    if grp.size < 512 || grp.size > 4096 || (grp.size mod 64) <> 0 then
      raise (Error Wrong_key_size);
...
(* replace with these once DSA works
  ...
  let dsa_size = 3072
*)
  let dsa_p = ""
  let dsa_q = "c99d04c20d89566ef8871d145844c28fe347ce61"
  let dsa_g = ""
  let dsa_size = 1024
  ...
  let default_group = make_group dsa_size dsa_p dsa_q dsa_g
